    ...
    <div class="flex flex-col md:flex-row items-center justify-between px-8 py-12 max-w-7xl mx-auto">
      ...
      <div class="md:w-1/2 space-y-6">
        ...
        <p class="text-gray-600 max-w-md">
          Access expert veterinary care, treatment, and wellness services all in one platform.
          From routine checkups to emergency support, we’ve got your pet covered.
        </p>
      ...
      <div class="md:w-1/2 mt-10 md:mt-0 relative">
        <img src="https://i.ibb.co/DfBwPxnB/dog000-1.png" alt="dog" class="w-full max-w-sm mx-auto" />
        ...
        <div class="absolute bottom-4 left-10 bg-white px-3 py-1 rounded-lg shadow-md text-center text-sm">
          <p class="text-blue-600 font-semibold">15K+</p>
          <p class="text-gray-600">Internation Project Completed</p>
        </div>
      </div>
    </div>
    </section>
